<template>
  <!-- eslint-disable -->
  <!-- /* eslint-disable */ -->
  <MetricaModal :item="state.item" :apiAction="apiAction" :laboratorios="state.laboratorios" 
    :productos="state.productos" ></MetricaModal>

  <Metricas widget-classes="mb-5 mb-xl-8"
  :deleteItem="showAlert" :sucursales="state.sucursales" :setItem="setItem"></Metricas>
...
import Metricas from "@/components/widgets/tables/Metricas.vue";
import { Actions, Mutations } from "@/store/enums/StoreEnums";
import { useStore } from "vuex";
import { useRouter } from "vue-router";
import Swal from "sweetalert2/dist/sweetalert2.min.js";
import MetricaModal from "@/components/modals/forms/Metrica.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(async () => {
      setCurrentPageBreadcrumbs("Modulo de Reportes Metricas", []);
      initTable();
      listLaboratorios();
      listProductos();
    });

  ...
  <div class="card">
    ...
    <div class="card-header card-header-stretch">
      ...
      <div class="card-title d-flex align-items-center">
        ...
        <h3 class="fw-bold m-0 text-gray-800">Mis ordenes</h3>
      </div>
      <!--end::Title-->
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      await store.dispatch(Actions.LIST_MIS_ORDENES, {});
      state.ordenes = store.getters.currentMisOrdenes.ordenes;
      console.log("currentMisOrdenes: " , store.getters.currentMisOrdenes);

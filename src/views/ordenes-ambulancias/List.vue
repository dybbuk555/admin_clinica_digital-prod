<template>
  ...
  <OrdenAmbulanciaModal :rol="state.rol" :item="state.orden" :apiAction="apiAction" :setSucursal="setSucursal"
    :sucursal="state.sucursal" :setProducto="setProducto" :updatePrecio="updatePrecio" :sucursales="state.sucursales">
  </OrdenAmbulanciaModal>

  <OrdenAmbulancias widget-classes="mb-5 mb-xl-8" :ordenes="state.ordenes" :listSucursales="listSucursales" :setOrden="setOrden"
    :setOrdenEdit="setOrdenEdit" :deleteItem="showAlert" :rol="state.rol" :user="state.user"></OrdenAmbulancias>
</template>
...
import OrdenAmbulancias from "@/components/widgets/tables/OrdenAmbulancias.vue";
import { Actions, Mutations } from "@/store/enums/StoreEnums";
import { useStore } from "vuex";
import { useRouter } from "vue-router";
import Swal from "sweetalert2/dist/sweetalert2.min.js";
import OrdenAmbulanciaModal from "@/components/modals/forms/OrdenAmbulancia.vue";

export default defineComponent({
  name: "ordenes-list",
  components: { OrdenAmbulanciaModal, OrdenAmbulancias },
  setup() {

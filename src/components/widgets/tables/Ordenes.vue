    ...
    <div class="card-body py-3">
      ...
      <div class="table-responsive">
          ...
          >
            ...
            <template v-slot:folio="{ row: item }">
                  <a @click="props.setOrden(item)"
            ...
            <template v-slot:cita="{ row: item }">
                  <a class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6"
                    >{{ moment(new Date(item.fecha)).format("DD/MM/YYYY") }}</a
                  >
            ...
            <template v-slot:cant="{ row: item }">
                  <a
                    href="#"
                    class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6"
                    >{{ item.products.length }}</a
                  >

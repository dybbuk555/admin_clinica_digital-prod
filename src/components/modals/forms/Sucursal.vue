    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <!--begin::Modal title-->
          <h2 v-if="props.item.nuevo == ''">Crear sucursal</h2>
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          <Form id="kt_modal_new_card_form" class="form" @submit="submit" :validation-schema="validationSchema">
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              ...
              <Field type="text" class="form-control form-control-solid" name="direccion"
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <label class="d-flex align-items-center fs-6 fw-semobold form-label mb-2">
                <span class="required">Horario de muestras</span>
                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                  title="Specify a card holder's name"></i>
              </label>

              <Field type="text" class="form-control form-control-solid" name="horarioMuestras"
                v-model="props.item.horarioMuestras" />
              <div class="fv-plugins-message-container">
                <div class="fv-help-block">
                  <ErrorMessage name="horarioMuestras" />
                </div>
              </div>
            </div>
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              ...
              <select data-control="select2" data-hide-search="true" name="sucursal"
                class="form-select form-select-white form-select-sm fw-bold" v-model="props.item.laboratorio_id">
                <option label="Selecciona una opción " value=""></option>
                <option v-for="(item, index) in props.laboratorios" :key="index" :label="item.nombre" :value="item._id">
                </option>
              </select>
            </div>
            ...
            <div class="d-flex flex-stack">
              <div class="me-5">
                ...
                <div class="fs-7 fw-semobold text-gray-400">
                  Si la sucursal ofrece servicio a domicilio
                </div>
              </div>
              <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input" type="checkbox" v-model="props.item.servicioDomicilio" />
              </label>
            </div>
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              ...
              <div style="height: 75vh; width: 50vw;">
                <GMapMap
                  :center="{lat: Number(props.item.ubicacion.lat), lng: Number(props.item.ubicacion.long) }"
                  :zoom="10"
                >
                  <GMapCluster>
                    <GMapMarker
                        :position="{lat: Number(props.item.ubicacion.lat), lng: Number(props.item.ubicacion.long) }"
                        :clickable="true"
                        :draggable="true"
